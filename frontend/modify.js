...
const file = '/Users/pavithrameddaduwage/Downloads/powerbi-backup/frontend/src/app/upload.component.ts';
...
const originalTemplate = content.slice(templateStart, templateEnd);
...
content = content.replace(originalTemplate, newTemplate);

// also replace some <button> to <button class="btn-primary"> if they are sync or upload
// We already did that in the new template string manually.
// Some older buttons in the original template were <button class="secondary">, we changed to btn-secondary in the new template

fs.writeFileSync(file, content);
console.log('Successfully updated upload.component.ts');
